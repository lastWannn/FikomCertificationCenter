      ...
      <div style="background:#FFFFFF;border-radius:24px;border:2.5px solid #131218;max-width:480px;width:100%;box-shadow:0 24px 60px rgba(0,0,0,0.4);overflow:hidden;position:relative;animation:modalPop 0.25s ease-out;z-index:1000000;">
        ...
        <div style="padding:28px 30px;text-align:center;">
          ...
          <div style="display:flex;justify-content:center;gap:12px;margin-bottom:20px;" id="otp-digit-container">
            <input type="text" maxlength="1" id="otp-digit-1" class="otp-box-input" autocomplete="off" inputmode="numeric" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'')" style="width:56px;height:62px;border-radius:14px;border:2.5px solid #CBD5E1;text-align:center;font-size:28px;font-weight:900;color:#131218;background:#FFFFFF;font-family:monospace;transition:all .18s;cursor:text;position:relative;z-index:1000000;" onfocus="this.style.borderColor='#131218';this.select();" onblur="this.style.borderColor='#CBD5E1';">
            <input type="text" maxlength="1" id="otp-digit-2" class="otp-box-input" autocomplete="off" inputmode="numeric" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'')" style="width:56px;height:62px;border-radius:14px;border:2.5px solid #CBD5E1;text-align:center;font-size:28px;font-weight:900;color:#131218;background:#FFFFFF;font-family:monospace;transition:all .18s;cursor:text;position:relative;z-index:1000000;" onfocus="this.style.borderColor='#131218';this.select();" onblur="this.style.borderColor='#CBD5E1';">
            <input type="text" maxlength="1" id="otp-digit-3" class="otp-box-input" autocomplete="off" inputmode="numeric" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'')" style="width:56px;height:62px;border-radius:14px;border:2.5px solid #CBD5E1;text-align:center;font-size:28px;font-weight:900;color:#131218;background:#FFFFFF;font-family:monospace;transition:all .18s;cursor:text;position:relative;z-index:1000000;" onfocus="this.style.borderColor='#131218';this.select();" onblur="this.style.borderColor='#CBD5E1';">
            <input type="text" maxlength="1" id="otp-digit-4" class="otp-box-input" autocomplete="off" inputmode="numeric" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'')" style="width:56px;height:62px;border-radius:14px;border:2.5px solid #CBD5E1;text-align:center;font-size:28px;font-weight:900;color:#131218;background:#FFFFFF;font-family:monospace;transition:all .18s;cursor:text;position:relative;z-index:1000000;" onfocus="this.style.borderColor='#131218';this.select();" onblur="this.style.borderColor='#CBD5E1';">
          </div>
  ...
  <div style="background:#131218;width:100%;max-width:420px;border-radius:24px;padding:36px 32px;box-shadow:0 24px 64px rgba(0,0,0,0.7);border:1.5px solid rgba(255,200,26,0.25);text-align:center;position:relative;">
    ...
    <form action="{{ route('peserta.profile.verify-email-otp') }}" method="POST">
      ...
      <div style="display:flex;gap:12px;justify-content:center;margin-bottom:22px;">
        <input type="text" maxlength="1" id="otp-1" class="profile-otp-box" autocomplete="off" inputmode="numeric" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'')" required autofocus style="width:48px;height:52px;background:rgba(255,255,255,0.05);border:1.5px solid rgba(255,255,255,0.15);border-radius:12px;text-align:center;font-size:22px;font-weight:900;color:#FFFFFF;transition:all 0.2s ease;outline:none;" onfocus="this.style.borderColor='#FFC81A';this.style.background='rgba(255,200,26,0.08)';this.style.boxShadow='0 0 0 3px rgba(255,200,26,0.2)';this.select();" onblur="this.style.borderColor='rgba(255,255,255,0.15)';this.style.background='rgba(255,255,255,0.05)';this.style.boxShadow='none';">
        <input type="text" maxlength="1" id="otp-2" class="profile-otp-box" autocomplete="off" inputmode="numeric" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'')" required style="width:48px;height:52px;background:rgba(255,255,255,0.05);border:1.5px solid rgba(255,255,255,0.15);border-radius:12px;text-align:center;font-size:22px;font-weight:900;color:#FFFFFF;transition:all 0.2s ease;outline:none;" onfocus="this.style.borderColor='#FFC81A';this.style.background='rgba(255,200,26,0.08)';this.style.boxShadow='0 0 0 3px rgba(255,200,26,0.2)';this.select();" onblur="this.style.borderColor='rgba(255,255,255,0.15)';this.style.background='rgba(255,255,255,0.05)';this.style.boxShadow='none';">
