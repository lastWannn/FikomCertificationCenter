...
<div style="padding:24px;">
    ...
    @endphp
    <a href="{{ route('peserta.pembayaran.show', $p) }}" style="text-decoration:none;color:inherit;display:block;margin-bottom:14px;outline:none;"
       onmouseover="this.querySelector('.fcc-card').style.borderColor='#FFC81A';this.querySelector('.fcc-card').style.transform='translateY(-2px)'"
       onmouseout="this.querySelector('.fcc-card').style.borderColor='#E2E4EB';this.querySelector('.fcc-card').style.transform='translateY(0)'">
        <div class="fcc-card" style="padding:20px 24px;display:flex;align-items:center;gap:18px;cursor:pointer;transition:all .18s;">
