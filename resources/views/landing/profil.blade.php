...
<div style="padding-top:68px; background:linear-gradient(180deg, #131218 0%, #0e0d14 120px, #0e0d14 100%); min-height: calc(100vh - 68px);">
    ...
    {{-- Tabs Navigation --}}
    <div style="background: rgba(14, 13, 20, 0.85); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border-bottom: 1px solid rgba(255,255,255,.05); position: sticky; top: 68px; z-index: 50; box-shadow: 0 4px 20px rgba(0,0,0,0.2);">
        <div style="max-width: 1100px; margin: 0 auto; padding: 0 24px; display: flex; justify-content: center; gap: 8px;" id="profil-tabs">
            ...
            <button onclick="showTab('{{ $v }}')" id="tab-{{ $v }}"
                style="padding: 18px 24px; border: none; background: none; font-weight: 800; font-size: 14px; cursor: pointer; transition: all .25s ease; position: relative; margin-bottom:-1px;
                       color: {{ $loop->first ? '#FFF' : 'rgba(255,255,255,.5)' }}; border-bottom: 3px solid {{ $loop->first ? '#FFC81A' : 'transparent' }};">
                {{ $l }}
            </button>
            @endforeach
        </div>
    ...
    <div style="padding: 56px 24px; max-width: 1100px; margin: 0 auto;">
        ...
        <div id="content-tentang">
            <div style="display:grid; grid-template-columns: 1.1fr 0.9fr; gap:48px; align-items:start;">
                <div style="padding-top: 8px;">
                    ...
                    <h3 style="font-size: 28px; font-weight: 900; color: #FFF; margin: 0 0 20px; letter-spacing: -0.5px; line-height: 1.3;">
                        Membangun Talenta Digital <br>
                        <span style="color: #FFC81A;">Kompeten & Berdaya Saing</span>
                    </h3>
                    <p style="color: rgba(255,255,255,.6); font-size: 15.5px; line-height: 1.85; margin: 0 0 18px; font-weight: 500;">
                    ...
                    <p style="color: rgba(255,255,255,.6); font-size: 15.5px; line-height: 1.85; margin: 0 0 32px; font-weight: 500;">
                    ...
                    <div style="display: flex; gap: 16px;">
                        <a href="{{ route('landing.kegiatan') }}" class="fcc-btn-gold btn-shine" style="padding: 14px 28px; font-size: 14px; font-weight: 700; border-radius: 12px; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; box-shadow: 0 8px 24px rgba(255, 200, 26, 0.25);">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <!-- Stat Card 1 -->
                    <div class="fcc-card-dark" style="padding: 28px 24px; border-radius: 20px; background: rgba(255,255,255,.03); transition: all 0.3s ease; display: flex; flex-direction: column; justify-content: space-between; border: 1.5px solid rgba(255,255,255,.08);"
                        ...
                        <div>
                            <p style="margin: 0; color: #FFF; font-size: 28px; font-weight: 900; letter-spacing: -1px; line-height: 1;">2020</p>
                            <p style="margin: 6px 0 0; color: rgba(255,255,255,.6); font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Tahun Berdiri</p>
                        </div>
                    </div>
                    <!-- Stat Card 2 -->
                    <div class="fcc-card-dark" style="padding: 28px 24px; border-radius: 20px; background: rgba(255,255,255,.03); transition: all 0.3s ease; display: flex; flex-direction: column; justify-content: space-between; border: 1.5px solid rgba(255,255,255,.08);"
                        ...
                        <div>
                            <p style="margin: 0; color: #FFF; font-size: 28px; font-weight: 900; letter-spacing: -1px; line-height: 1;">342+</p>
                            <p style="margin: 6px 0 0; color: rgba(255,255,255,.6); font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Total Alumni</p>
                        </div>
                    </div>
                    <!-- Stat Card 3 -->
                    <div class="fcc-card-dark" style="padding: 28px 24px; border-radius: 20px; background: rgba(255,255,255,.03); transition: all 0.3s ease; display: flex; flex-direction: column; justify-content: space-between; border: 1.5px solid rgba(255,255,255,.08);"
                        ...
                        <div>
                            <p style="margin: 0; color: #FFF; font-size: 28px; font-weight: 900; letter-spacing: -1px; line-height: 1;">25+</p>
                            <p style="margin: 6px 0 0; color: rgba(255,255,255,.6); font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Program Aktif</p>
                        </div>
                    </div>
                    <!-- Stat Card 4 -->
                    <div class="fcc-card-dark" style="padding: 28px 24px; border-radius: 20px; background: rgba(255,255,255,.03); transition: all 0.3s ease; display: flex; flex-direction: column; justify-content: space-between; border: 1.5px solid rgba(255,255,255,.08);"
                        ...
                        <div>
                            <p style="margin: 0; color: #FFF; font-size: 28px; font-weight: 900; letter-spacing: -1px; line-height: 1;">12+</p>
                            <p style="margin: 6px 0 0; color: rgba(255,255,255,.6); font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Mitra Industri</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="content-visi" style="display:none;">
            <div style="display:grid;grid-template-columns:1fr;gap:24px;">
                <div class="fcc-card-dark" style="padding:32px 36px;transition:all .3s ease;"
                     onmouseover="this.style.boxShadow='0 12px 32px rgba(255,200,26,0.15)';this.style.transform='translateY(-4px)';this.style.borderColor='rgba(255,200,26,.3)'"
                     onmouseout="this.style.boxShadow='0 2px 8px rgba(0,0,0,0.2)';this.style.transform='translateY(0)';this.style.borderColor='rgba(255,255,255,.08)'">
                    <div style="display:flex;align-items:center;gap:14px;margin-bottom:18px;">
                        ...
                        <span style="font-size:20px;font-weight:900;color:#FFF;letter-spacing:-0.5px;">Visi</span>
                    </div>
                    <p style="color:rgba(255,255,255,.6);font-size:15px;line-height:1.9;margin:0;">Menjadi unit pelatihan dan sertifikasi profesional yang mampu mencetak tenaga kerja yang berkualitas, terampil dan mandiri sesuai dengan Standar Kompetensi Nasional maupun Internasional sehingga dapat mengisi peluang kerja dan mampu menciptakan lapangan kerja.</p>
                </div>

                <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;">
                    <div class="fcc-card-dark" style="padding:32px 36px;transition:all .3s ease;"
                         onmouseover="this.style.boxShadow='0 12px 32px rgba(16,185,129,0.15)';this.style.transform='translateY(-4px)';this.style.borderColor='rgba(16,185,129,.3)'"
                         onmouseout="this.style.boxShadow='0 2px 8px rgba(0,0,0,0.2)';this.style.transform='translateY(0)';this.style.borderColor='rgba(255,255,255,.08)'">
                        <div style="display:flex;align-items:center;gap:14px;margin-bottom:22px;">
                            ...
                            <span style="font-size:20px;font-weight:900;color:#FFF;letter-spacing:-0.5px;">Misi</span>
                        </div>
                        <div style="display:flex;flex-direction:column;gap:16px;">
                            ...
                            <div style="display:flex;align-items:flex-start;gap:12px;">
                                ...
                                <span style="color:rgba(255,255,255,.6);font-size:14.5px;line-height:1.75;">{{ $misi }}</span>
                            </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="fcc-card-dark" style="padding:32px 36px;transition:all .3s ease;"
                         onmouseover="this.style.boxShadow='0 12px 32px rgba(59,130,246,0.15)';this.style.transform='translateY(-4px)';this.style.borderColor='rgba(59,130,246,.3)'"
                         onmouseout="this.style.boxShadow='0 2px 8px rgba(0,0,0,0.2)';this.style.transform='translateY(0)';this.style.borderColor='rgba(255,255,255,.08)'">
                        <div style="display:flex;align-items:center;gap:14px;margin-bottom:22px;">
                            ...
                            <span style="font-size:20px;font-weight:900;color:#FFF;letter-spacing:-0.5px;">Tujuan</span>
                        </div>
                        <div style="display:flex;flex-direction:column;gap:16px;">
                            @foreach([
                            ...
                            <div style="display:flex;align-items:flex-start;gap:12px;">
                                ...
                                <span style="color:rgba(255,255,255,.6);font-size:14.5px;line-height:1.75;">{{ $tujuan }}</span>
                            </div>
                            @endforeach
                        </div>
                    </div>
        ...
        <div id="content-mitra" style="display:none;">
            <div style="text-align:center; max-width:600px; margin: 0 auto 36px;">
                <h3 style="font-size:22px; font-weight:900; color:#FFF; margin:0 0 10px;">Mitra Kolaborasi Strategis</h3>
                <p style="color:rgba(255,255,255,.6); font-size:14.5px; line-height:1.6; margin:0;">FIKOM Certification Center bekerja sama dengan berbagai penyedia sertifikasi dan vendor teknologi global untuk menghadirkan kurikulum berstandar internasional.</p>
            </div>
            <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:24px;">
                ...
                <div class="fcc-card-dark" style="padding:28px 20px;text-align:center;transition:all .22s ease;cursor:{{ $m->link_website ? 'pointer' : 'default' }};" 
                    ...
                    <div style="width:72px;height:72px;border-radius:16px;margin:0 auto 16px;background:{{ $m->warna ? $m->warna.'18' : '#FFC81A18' }};border:1.5px solid {{ $m->warna ? $m->warna.'40' : '#FFC81A40' }};display:flex;align-items:center;justify-content:center;overflow:hidden;">
                        @if($m->logo)
                        <img src="{{ asset('storage/'.$m->logo) }}" alt="{{ $m->nama_mitra }}" style="width:48px;height:48px;object-fit:contain;filter:brightness(0) invert(1);opacity:.85;">
                        @else
