...
<div style="padding:20px 24px;max-width:760px;">
  <a href="{{ route('admin.jadwal-sertifikasi.index') }}" style="display:inline-flex;align-items:center;gap:6px;color:#9CA3B0;font-size:13px;text-decoration:none;margin-bottom:16px;">
