{{-- ── EDIT MATERI MODAL (Neo-Brutalist Glassmorphism) ────────────────────────────────────── --}}
    ...
    <div style="background:#FFFFFF;border:2px solid #131218;border-radius:24px;padding:32px;max-width:520px;width:92%;position:relative;box-shadow:0 24px 60px rgba(0,0,0,0.3);display:flex;flex-direction:column;" onclick="event.stopPropagation()">
        ...
        <div style="margin-bottom:20px;border-bottom:2px solid #E5E7EB;padding-bottom:14px;">
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
                ...
                <h2 style="font-size:19px;font-weight:900;color:#131218;margin:0;">Edit Modul Materi</h2>
            </div>
            <p style="color:#64748B;font-size:12.5px;margin:0;font-weight:500;">Perbarui judul atau durasi jam pelajaran untuk modul ini.</p>
        </div>
        ...
        <form id="edit-materi-form" method="POST" action="">
            ...
            <div style="margin-bottom:24px;">
                ...
                <input type="number" id="edit-jp" name="jam_pelajaran" value="{{ old('jam_pelajaran') }}" min="1" required class="fcc-input" style="padding:9.5px 14px;font-size:13.5px;width:100%;border:1.5px solid #CBD5E1;border-radius:10px;">
