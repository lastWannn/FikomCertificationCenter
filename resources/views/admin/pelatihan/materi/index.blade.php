...
<div style="padding:24px;position:relative;">
    ...
    <style>
      ...
      #materi-skeleton-overlay {
        transition: opacity 0.35s ease, visibility 0.35s ease;
      }
    </style>

    <div id="materi-skeleton-overlay" class="no-print" style="opacity:1;visibility:visible;position:absolute;top:0;left:0;right:0;bottom:0;z-index:99;background:#F6F8FB;padding:24px;box-sizing:border-box;pointer-events:none;">
      {{-- Header Skeleton --}}
    ...
    <script>
      (function() {
        setTimeout(function() {
          var sk = document.getElementById('materi-skeleton-overlay');
          if (sk) {
            sk.style.opacity = '0';
