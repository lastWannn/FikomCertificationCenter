...
<div style="padding:24px;position:relative;">
    ...
    <style>
      ...
      #point-skeleton-overlay {
        transition: opacity 0.35s ease, visibility 0.35s ease;
      }
    </style>

    <div id="point-skeleton-overlay" class="no-print" style="opacity:1;visibility:visible;position:absolute;top:0;left:0;right:0;bottom:0;z-index:99;background:#F6F8FB;padding:24px;box-sizing:border-box;pointer-events:none;">
      {{-- Header Skeleton --}}
    ...
    <script>
      (function() {
        setTimeout(function() {
          var sk = document.getElementById('point-skeleton-overlay');
          if (sk) {
            sk.style.opacity = '0';
                    ...
                    <tr style="border-top:1px solid #F1F5F9;transition:background .15s;" onmouseover="this.style.background='#F8FAFC'" onmouseout="this.style.background=''">
                        ...
                        <td style="padding:14px 16px;text-align:center;vertical-align:middle;">
                            ...
                            <div style="display:inline-flex;flex-direction:column;align-items:center;gap:4px;">
                                ...
                                @if($isBelum)
                                <span style="font-size:10px;font-weight:800;padding:2px 8px;border-radius:6px;background:#FFFDF5;color:#D97706;border:1px solid #FCD34D;display:inline-flex;align-items:center;gap:3px;" title="Pelatihan belum dimulai">
