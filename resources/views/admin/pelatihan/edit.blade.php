...
<div style="padding:24px;">
    ...
    <form action="{{ $edit ? route('admin.pelatihan.update', $pelatihan) : route('admin.pelatihan.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="display:grid;grid-template-columns:2fr 1fr;gap:20px;">
            <div>
                <div class="fcc-card" style="padding:24px;margin-bottom:16px;">
                    <h3 style="font-size:15px;font-weight:800;color:#0F0F14;margin:0 0 18px;">Informasi Pelatihan</h3>
                    ...
                    <div>
                        ...
                        <textarea name="isi" rows="7" placeholder="Deskripsi program pelatihan..." required class="fcc-input" style="resize:vertical;">{{ old('isi',$pelatihan->isi??'') }}</textarea>
                    </div>
                </div>
            </div>
            <div>
                ...
                <div class="fcc-card" style="padding:24px;">
                    ...
                    @if($edit && isset($pelatihan->gambar) && $pelatihan->gambar)
                    <img src="{{ asset('storage/'.$pelatihan->gambar) }}" style="width:100%;border-radius:10px;margin-bottom:12px;max-height:160px;object-fit:cover;">
                    @endif
        ...
        <div style="display:flex;gap:10px;margin-top:18px;">
            ...
            <a href="{{ route('admin.pelatihan.index') }}" style="padding:11px 20px;font-size:14px;font-weight:700;color:#6B7280;text-decoration:none;background:#F7F8FA;border:1px solid #E2E4EB;border-radius:10px;">Batal</a>
        </div>
    </form>
