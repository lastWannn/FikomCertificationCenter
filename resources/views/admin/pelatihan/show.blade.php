        ...
        <div style="padding:12px 18px;border-top:1px solid #F0F1F5;">
          <div style="display:flex;justify-content:space-between;align-items:center;">
            <div>
              ...
              @php
                $effectiveBiaya = $kp?->kegiatan?->biaya;
              @endphp
            ...
            <div style="display:flex;align-items:center;gap:6px;flex-wrap:nowrap;">
              ...
              @php
                $st = $kp?->kegiatan?->status ?? 'draf';
              @endphp
              <form action="{{ route('admin.jadwal-pelatihan.status', $j) }}" method="POST" style="margin:0;display:inline-block;">
                @csrf
              ...
              @if($kp)
                ...
                <a href="{{ route('admin.kegiatan.show', $kp->kegiatan) }}" target="_blank" title="Lihat Detail Kegiatan"
            ...
            <div style="background:#FFFFFF;border:2px solid #131218;border-radius:24px;padding:32px;max-width:640px;width:92%;position:relative;box-shadow:0 24px 60px rgba(0,0,0,0.3);max-height:90vh;overflow-y:auto;display:flex;flex-direction:column;text-align:left;" onclick="event.stopPropagation()">
                ...
                <div style="margin-bottom:20px;border-bottom:2px solid #E5E7EB;padding-bottom:14px;">
                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
                        ...
                        <h2 style="font-size:19px;font-weight:900;color:#131218;margin:0;">Edit Jadwal Pelatihan</h2>
                    </div>
                ...
                <form action="{{ route('admin.jadwal-pelatihan.update', $j) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div style="margin-bottom:14px;">
                        ...
                        <input type="text" name="nama_kegiatan" value="{{ old('nama_kegiatan', $j->nama_kegiatan) }}" placeholder="Contoh: {{ $pelatihan->judul }} - Batch" class="fcc-input" style="padding:9px 14px;font-size:13.5px;width:100%;border:1.5px solid #CBD5E1;border-radius:10px;">
                    </div>
