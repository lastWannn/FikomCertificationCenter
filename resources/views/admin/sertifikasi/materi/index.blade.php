...
<div style="padding:24px;position:relative;">
    ...
    <div id="materi-sertifikasi-skeleton-overlay" class="no-print" style="opacity:1;visibility:visible;position:absolute;top:0;left:0;right:0;bottom:0;z-index:99;background:#F6F8FB;padding:24px;box-sizing:border-box;pointer-events:none;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
        ...
        <div class="fcc-skeleton-box" style="width:160px;height:40px;border-radius:30px;"></div>
      </div>
      <div style="padding:22px;border-radius:20px;background:#FFFFFF;border:2px solid #E5E7EB;margin-bottom:24px;">
        <div class="fcc-skeleton-box" style="width:200px;height:12px;margin-bottom:10px;"></div>
        <div class="fcc-skeleton-box" style="width:100%;height:46px;border-radius:12px;"></div>
      </div>
    ...
    <script>
      (function() {
        setTimeout(function() {
          var sk = document.getElementById('materi-sertifikasi-skeleton-overlay');
          if (sk) {
            sk.style.opacity = '0';
