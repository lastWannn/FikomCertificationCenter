        ...
        <table style="width:100%;border-collapse:collapse;">
            ...
            <tbody>
                ...
                <tr class="tbl-row" style="border-top:1px solid #F0F1F3;">
                    <td style="padding:12px 20px;font-size:13px;font-weight:700;color:#3B82F6;font-family:monospace;">{{ $s->kode }}</td>
                    <td style="padding:12px 12px;">
                        <p style="font-size:14px;font-weight:700;color:#0F0F14;margin:0;">{{ $s->judul }}</p>
                        <p style="font-size:11px;color:#A0A3AD;margin:2px 0 0;">{{ $s->jadwal()->count() }} jadwal &bull; {{ $s->materi()->count() }} materi</p>
                    </td>
                    <td style="padding:12px 12px;font-size:13px;color:#6B7280;">{{ $s->kategori->nama_kategori ?? '-' }}</td>
                ...
                @empty
                <tr><td colspan="4" style="padding:32px;text-align:center;color:#A0A3AD;font-size:14px;">Belum ada data sertifikasi.</td></tr>
                @endforelse
            </tbody>
        </table>
