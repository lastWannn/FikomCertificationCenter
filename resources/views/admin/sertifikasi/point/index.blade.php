...
<div style="padding:24px;">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
        <div>
            <h1 style="font-size:24px;font-weight:900;color:#131218;margin:0 0 4px;letter-spacing:-0.5px;">Point Peserta Sertifikasi</h1>
            <p style="color:#6B7280;margin:0;font-size:14px;">Pilih jadwal sertifikasi untuk mengelola point/nilai peserta.</p>
        </div>
    </div>
            ...
            <table style="width:100%;border-collapse:collapse;font-size:13.5px;">
                <thead>
                    <tr style="background:#F7F8FA;border-bottom:1px solid #E2E4EB;">
                        ...
                        <th style="text-align:left;padding:14px 24px;font-weight:800;color:#9CA3B0;text-transform:uppercase;font-size:11px;letter-spacing:0.5px;">Sertifikasi</th>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:1px solid #F0F1F5;transition:background .2s;" onmouseover="this.style.background='#F8F9FB'" onmouseout="this.style.background='none'">
                        ...
                        <td style="padding:16px 24px;text-align:center;">
                            <a href="{{ route('admin.sertifikasi.point.show', $item->id) }}" class="fcc-btn-gold" style="padding:8px 16px;font-size:11.5px;font-weight:800;border:none;border-radius:8px;cursor:pointer;display:inline-block;text-decoration:none;">
                                INPUT NILAI PESERTA
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="6" style="text-align:center;padding:48px 24px;color:#9CA3B0;">
                            ...
                            <p style="font-weight:700;color:#6B7280;margin:0 0 4px;font-size:14px;">Belum Ada Jadwal Sertifikasi</p>
                            <p style="font-size:12.5px;margin:0;">Jadwal sertifikasi yang aktif akan muncul di sini.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
