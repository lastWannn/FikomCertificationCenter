...
<head>
  ...
  <title>Perpanjangan Waktu Tidak Disetujui</title>
</head>
          ...
          <tr>
            <td style="padding: 32px;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    ...
                    <td style="vertical-align: middle; font-size: 13.5px; font-weight: 700; color: #991B1B;">
                      Permintaan Perpanjangan Waktu Tidak Disetujui
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <h2 style="margin: 0 0 12px; font-size: 20px; font-weight: 800; color: #0F172A; letter-spacing: -0.3px;">
                Informasi Status Perpanjangan Waktu
              </h2>
              ...
              <p style="margin: 0 0 24px; font-size: 14.5px; color: #475569; line-height: 1.6;">
                Maaf, permintaan perpanjangan waktu pembayaran Anda tidak dapat disetujui oleh Admin FCC.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #F8FAFC; border: 1px solid #E2E8F0; border-radius: 12px; margin-bottom: 24px;">
                ...
                <tr>
                  <td style="padding: 14px 18px;">
                    <span style="font-size: 11px; font-weight: 700; color: #64748B; text-transform: uppercase; letter-spacing: 0.5px;">Alasan Admin</span>
                  </td>
                  <td style="padding: 14px 18px;">
                    <span style="font-size: 13.5px; font-weight: 700; color: #991B1B;">{{ $catatan }}</span>
                  </td>
                </tr>
                @endif
              </table>
              ...
              <p style="margin: 0 0 24px; font-size: 13.5px; color: #64748B; line-height: 1.6;">
                Jika Anda memiliki pertanyaan lebih lanjut, silakan hubungi tim Helpdesk Admin FCC melalui menu kontak.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center" style="padding-top: 8px;">
                    <a href="{{ config('app.url') }}/hubungi-kami" target="_blank" style="display: inline-block; background-color: #131218; color: #FFC81A; font-size: 14px; font-weight: 800; text-decoration: none; padding: 14px 32px; border-radius: 10px; border: 1px solid #131218;">
                      Hubungi Admin &rarr;
                    </a>
                  </td>
                </tr>
