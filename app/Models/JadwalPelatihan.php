...
class JadwalPelatihan extends Model {
    ...
    protected $fillable=['pelatihan_id','nama_kegiatan','nama_jenis_biaya','nominal_biaya','kuota_peserta','untuk_peserta','tgl_batas_daftar','tgl_pelaksanaan','jam_mulai','jam_selesai'];
